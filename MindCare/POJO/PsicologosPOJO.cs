...
namespace MindCare
{
    public class PsicologosPOJO
    {
        ...
        public PsicologosPOJO() { }

        public PsicologosPOJO(string nombre, string apellidos, int edad, string direccion, string poblacion, string provincia, string pais, string nif, 
